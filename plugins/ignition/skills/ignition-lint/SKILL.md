...
**Perspective issues:** `EMPTY_COMPONENT_NAME`, `GENERIC_COMPONENT_NAME`, `MISSING_TAG_PATH`, `MISSING_TAG_FALLBACK`, `MISSING_EXPRESSION`, `INVALID_BINDING_TYPE`, `UNUSED_CUSTOM_PROPERTY`, `UNUSED_PARAM_PROPERTY`, `MISSING_PARAM_DIRECTION`, `PERFORMANCE_CONSIDERATION`, `ACCESSIBILITY_LABELING`
