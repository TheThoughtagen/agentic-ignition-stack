...
## Plugin vs repository instructions

The plugin is globally reusable across Ignition projects. This stack also includes repository-local conventions in the root [`CLAUDE.md`](../../CLAUDE.md); keep those project-specific instructions under version control while the plugin supplies shared Ignition knowledge, hooks, and scaffolding.
...
Common codes reported by the hook and lint skill are listed below. See the [ignition-lint documentation](https://pypi.org/project/ignition-lint-toolkit/) for the complete rule reference.
